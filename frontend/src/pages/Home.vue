...
function submit(){
    ...
    formData.append('image', imageData.value.image);
    formData.append('label', imageData.value.label);
    ...
    <main>
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-4 flex text-sm/6 text-gray-600">
                            <label for="file-upload"
                                ...
                                <input @change="imageData.image = $event.target.files[0]" id="file-upload" name="file-upload" type="file" class="sr-only" />
                            </label>
           ...
           <div class="mb-3">
            ...
            <div class="mt-2">
              <input v-model="imageData.label" type="text" name="label" id="label" autocomplete="given-name" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
            </div>
          </div>
            <button type="submit"
